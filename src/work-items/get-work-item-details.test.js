const createWorkItemDetailsGetter = require('./get-work-item-details')

describe('createWorkItemDetailsGetter', () => {
  [
    ...
    test(`requires ${testName}`, () => {
      const fn = () => createWorkItemDetailsGetter(input)
  ...
  test('returns a function', () => {
    ...
    const fn = createWorkItemDetailsGetter(options)
...
describe('getWorkItemDetails', () => {
  test.each([
    ...
    const getWorkItemDetails = createWorkItemDetailsGetter(createOptions())
    const fn = () => getWorkItemDetails(input)
  ...
  test('maps results from the API', async () => {
    ...
    const getWorkItemDetails = createWorkItemDetailsGetter({ ...createOptions(), fetch: fetchMock })
    const real = await getWorkItemDetails([5])
